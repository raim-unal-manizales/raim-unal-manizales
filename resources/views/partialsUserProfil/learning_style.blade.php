...
<div id="test" style="">
    ...
    <input type="hidden" name="inicial-Learning" id="inicial-Learning" value="Si">

    <table class="table2" width="100%" border="0" cellspacing="5" cellpadding="0" align="center"  id="test-learning-style">
        <tr>
