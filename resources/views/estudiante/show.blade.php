    ...
    <div class="col-md-4">
      <div class="panel panel-default">
        ...
        <div class="panel-footer">
          <a href="{{ route('Estudiante.index') }}" class="btn btn-danger">Volver</a>
          <a href="{{ route('Estudiante.edit', $user->id) }}" class="btn btn-primary pull-right">Editar</a>
        </div>
      </div>
    </div>
    <div class="col-md-8">
     <!-- Inicio de estilos de aprendizaje -->
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-footer text-right">
                  <a href="{{ route('Estudiante.edit', $user->id) }}" class="btn btn-primary">Editar Needs</a>
              </div>
            </div>
    </div>
  </div>
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="col-md-4 text-cente">
              <img class="profile-user-img img-responsive img-circle center-block" width="50" height="50" src="{{ asset($aplication->logo) }}" alt="User profile picture">
          ...
          <div class="panel-footer text-right"><a href="{{ route('Estudiante.edit', $user->id) }}" class="">Visitar</a></div>
        </div>
      </div>
    @endforeach
  </div>
