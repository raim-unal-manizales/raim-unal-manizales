        ...
        <div class="fieldForm">
            ...
            {!! Form::number('fondSize', 'value',['class' => '','id'=>'fondSize', 'placeholder' => '¿Desea Aumentar o Disrminuir el Tamaño de Fuente?'])!!}         
        </div>

       	<div class="fieldForm">
            {!! Form::label('interline','Tamaño de interlineado') !!}
            {!! Form::number('interline', 'value',['class' => '','id'=>'interline', 'placeholder' => '¿Desea Aumentar o Disrminuir el Tamaño del Interlineado?'])!!}         
        </div>
