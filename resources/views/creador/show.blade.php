    ...
    <div class="col-md-4">
      <div class="panel panel-default">
        ...
        <div class="panel-footer">
          <a href="{{ route('Creador.index') }}" class="btn btn-danger">Volver</a>
          <a href="{{ route('Creador.edit', $user->id) }}" class="btn btn-primary pull-right">Editar</a>
        </div>
      </div>
    </div>
    <div class="col-md-8">
     <!-- Inicio de estilos de aprendizaje -->
              ...
              <div class="panel-body">
                @if ($user->learningStyle()->first()->reference_learning_styles !== 1 )
                  <div class="col-md-7">
                    ...
                    <hr>
                    <a href="{{ route('Creador.estilosEdit', $user->id) }}" class="btn btn-primary center-block">Volver a realizar test</a>
                  </div>
                  <div class="col-md-5">
                ...
                @else
                  <div class="col-md-12">
                    ...
                    <a href="{{ route('Creador.estilosEdit', $user->id) }}" class="btn btn-primary center-block">Realizar test</a>
                  </div>
                @endif
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-footer text-right">
                  <a href="{{ route('Creador.edit', $user->id) }}" class="btn btn-primary">Editar Needs</a>
              </div>
            </div>
    </div>
  </div>
...
<div class="panel panel-default">
  <div class="panel-heading text-right">
        ...
        <a href=" {{ route('Creador.EditApps', $user->id) }}" class="btn btn-primary">Editar información de aplicaciones</a>
  </div>
    ...
    @foreach ($aplications as $aplication)
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-footer text-right"><a href="{{ route('Creador.edit', $user->id) }}" class="">Visitar</a></div>
        </div>
      </div>
    @endforeach
  </div>
